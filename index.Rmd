...
* Just enough of particle physics for bioinformaticians
...
Once this is done, a likelihood is constructed at fit to the data (e.g. [here](https://github.com/koskot77/OSUAnalysis/blob/master/cnt3j.C))
1410.1149

conceptually 
(apart from tedious bookkeeping for multiple of samples)
